...
int main()
{
    ...
    while (1)
    {
        ...
        imshow("Skin", frameDest);
         ...
         ////////////////////////////////////////
         // Part Two: Dynamic Gesture Recognition
         ////////////////////////////////////////
        ...
        /*
        built a nasty loop to count the accumulated horizontal frame differences. When the accumulated differences break a threshold (I set it as 350), a hand waving horizontally will be detected
        */
         ...
         for (int x = 0; x< myMH.rows; x++){
             ...
             if (i > 350) {
                 putText(frame0, "Hand Waving Horizontally", Point(100, 100), FONT_HERSHEY_COMPLEX_SMALL, 2, Scalar(255,255,255));
                 break;
             }
         }
